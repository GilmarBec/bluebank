...
class AgenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post agencies_url, params: { agency: { address_id: @agency.address_id, number: @agency.number } }
    end
  ...
  test "should update agency" do
    patch agency_url(@agency), params: { agency: { address_id: @agency.address_id, number: @agency.number } }
